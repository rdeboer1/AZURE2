find_path(MINUIT2_INCLUDE_DIR Minuit2/MnUserFcn.h
          HINTS C:/MinGW/msys/1.0/local/include $ENV{HOME}/local/include $ENV{HOME}/include $ENV{HOME}/include/Minuit2 $ENV{HOME}/miniconda3/include/Minuit2 $ENV{HOME}/miniconda3/include $ENV{ROOTSYS}/include /usr/include/root/)

find_library(MINUIT2_LIBRARY NAMES Minuit2
             HINTS C:/MinGW/msys/1.0/local/lib $ENV{HOME}/local/lib $ENV{HOME}/lib $ENV{HOME}/miniconda3/lib $ENV{ROOTSYS}/lib /usr/lib64/root/)
